...
- 20-30 мкА в режиме DeepSleep, с запущенным ULP, ведется подсчет импульсов
- 53 мА ESP32 нормальный режим работы, запущен ULP, WiFi/BT выключены
- 130 мА ESP32 в нормальном режиме работы, запущен ULP, WiFi подключен и передаются данные, BT выключен
- 80-130 мА ESP32 в нормально режиме работы, запущен ULP, WiFi/BT выключены, NB-IOT модем активирован, регистрация в сети и передача данных
